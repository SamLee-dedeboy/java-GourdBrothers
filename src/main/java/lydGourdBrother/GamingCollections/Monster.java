...
import lydGourdBrother.Beings.Minion;
import lydGourdBrother.Beings.Scorpion;
import lydGourdBrother.Beings.Serpent;
    ...
    public synchronized void crescent() {
        ...
        for (int i = 1; i <= col; i++) {
            if (i == 1) {
                ...
                cur++;
//                minions.get(cur).moveTo(lydGourdBrother.GamingCollections.BattleField.at(height / 2, width / 2 + 1));
//                cur++;
                minions.get(cur).moveTo(BattleField.at(height / 2 + 1, width / 2 + 1));
                cur++;
            } else {
